      ...
      <div class="max-w-2xl bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-lg p-6">
        ...
        <form method="POST" class="mt-4 space-y-4">
          <div>
            ...
            <select name="status" class="mt-1 w-full rounded-full px-4 py-2 border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark">
          ...
          <div>
            ...
            <input name="remarks" value="<?=h($row['remarks'])?>" class="mt-1 w-full rounded-full px-4 py-2 border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark">
          </div>

          <div>
            <label class="block text-sm font-medium">Issues</label>
            <textarea name="issues" rows="4" class="mt-1 w-full rounded-2xl px-4 py-2 border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark"><?=h($row['issues'])?></textarea>
          </div>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <a class="px-4 py-2 rounded-full bg-gray-200 dark:bg-gray-700 text-text-light dark:text-text-dark inline-flex items-center gap-1.5" href="<?= base_path('tasks/view.php?id='.$id) ?>">
